...
def home(request):
	if request.method == "POST":
		...
		Visitor.objects.create(name=name, mobile_no=mobile_no, address=address, purpose=purpose, photo=photo, document=document,contact_to=contact_to, date_time=datetime.now())
